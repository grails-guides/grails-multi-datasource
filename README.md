...
This repository contains the worked sample app for the [Grails Multi-datasource](https://grails.apache.org/guides/grails-multi-datasource/4/guide/index.html) guide on the Apache Grails site.
